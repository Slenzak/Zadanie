...
<head>
    ...
    <title>Borowinka</title>
    <link rel="stylesheet" href="Styl.css">
</head>
<body onload="roll(); roll2();">
    <div id="header">
      <div class="baner">
          <a id="img"></a>
          <script>
            async function roll2(){
              let img1="<img src='zdjecie1.png' class=imgban>";
              let img2='<img src="zdjecie2.png" class=imgban>';
              while(true){
          ...
          </script><img src="logo.png" id="logo"></div>
      </div>
    ...
    <div class="divcointener">
      <div id="middle">
        ...
        <form method="post" action="forum.php" class="contact">
            ...
            Podaj swojego maila<input type="text" name="email" required><br>
            <button type="submit" class="bsub">Wyslij</button><button type="reset" class="bres">Resetuj</button>
        </form>
      </div>
      <div class="right">
        <div class="container">
          <div class="calendar" id="calendar-app">
            <div class="calendar--day-view" id="day-view">
              ...
              <span class="day-view-date" id="day-view-date">MAJ 29 2016</span>
              <div class="day-view-content">
                <div class="day-highlight">
                  Ty <span class="day-events" id="day-events">Brak wydarzeń na dziś</span>. &nbsp; <span tabindex="0" onkeyup="if(event.keyCode != 13) return; this.click();" class="day-events-link" id="add-event" data-date>Dodać nowe wydarzenie?</span>
                </div>
                  ...
                  <div class="row">
                    <div class="half">
                      <label class="add-event-label">
                         Nazwa wydarzenia
                        <input type="text" class="add-event-edit add-event-edit--long" placeholder="Nowe wydarzenie" id="input-add-event-name">
                    ...
                    <div class="half">
                      <a onkeyup="if(event.keyCode != 13) return; this.click();" tabindex="0" id="add-event-save" class="event-btn--save event-btn">zapisz</a>
                      <a tabindex="0" id="add-event-cancel" class="event-btn--cancel event-btn">anuluj</a>
                    </div>
                  </div>
            ...
            <div class="calendar--view" id="calendar-view">
              <div class="cview__month">
                <span class="cview__month-last" id="calendar-month-last">Kwi</span>
                <span class="cview__month-current" id="calendar-month">Maj</span>
                <span class="cview__month-next" id="calendar-month-next">Cze</span>
              </div>
              <div class="cview__header">Sob</div>
              <div class="cview__header">Pon</div>
              <div class="cview__header">Wto</div>
              <div class="cview__header">Śro</div>
              <div class="cview__header">Czw</div>
              <div class="cview__header">Pią</div>
              <div class="cview__header">Nie</div>
              <div class="calendar--view" id="dates">
              </div>
            </div>
            <div class="footer">
              <span><span id="footer-date" class="footer__link">Dzis jest 30 Maj</span></span>    
            </div>
          </div>
        ...
        <div class="cointainer3"">
          ...
          <script>
              ...
              const zdjecia = ["<img src='zdjecie1.png'>","<img src='zdjecie2.png'>","<img src='zdjecie3.png'>","<img src='zdjecie4.png'>","<img src='zdjecie5.png'>","<img src='zdjecie6.png'>","<img src='zdjecie7.png'>","<img src='zdjecie8.png'>","<img src='zdjecie9.png'>","<img src='zdjecie10.png'>","<img src='zdjecie11.png'>","<img src='zdjecie12.png'>"]
              async function roll(){
                let range= (12-0) +0
                let a=Math.floor(Math.random() *range) +0
                let b=Math.floor(Math.random() *range) +0
                let c=Math.floor(Math.random() *range) +0
                let d=Math.floor(Math.random() *range) +0
                let e=Math.floor(Math.random() *range) +0
                while (a==b || a==c || a==d || a==e || b==c || b==d || b==e || c==d || c==e || d==e){
                a=Math.floor(Math.random() *range) +0
                b=Math.floor(Math.random() *range) +0
                c=Math.floor(Math.random() *range) +0
                d=Math.floor(Math.random() *range) +0
                e=Math.floor(Math.random() *range) +0
                }
                var cons=0
                while(cons!=1){
                document.getElementById('lol').innerHTML =zdjecia[a];
                await sleep(3000);
                document.getElementById('lol').innerHTML =zdjecia[b];
                await sleep(3000);
                document.getElementById('lol').innerHTML =zdjecia[c];
                await sleep(3000);
                document.getElementById('lol').innerHTML =zdjecia[d];
                await sleep(3000);
                document.getElementById('lol').innerHTML =zdjecia[e];
                await sleep(3000);
                }
