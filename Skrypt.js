function CalendarApp(date) {
    ...
    this.months = ['Styczen', 'Luty', 'Marzec', 'Kwiecien', 'Maj', 'Czerwiec', 'Lipiec', 'Sierpien', 'Wrzesien', 'Pazdziernik', 'Listopad', 'Grudzien'];
    this.apts = [
      {
    ...
    this.todayIsSpan.textContent = "Dziś jest " + this.months[date.getMonth()] + " " + date.getDate();  
  }
